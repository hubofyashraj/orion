    ...
    return (
        <>
            ...
            <div id="navbar" className="h-full z-50  top-0 md:p-0 text-slate-200  bg-slate-800 w-full flex justify-between items-center">
                <div onClick={()=>router('feed')} className="cursor-pointer px-4 bg-slate-900 w-20 flex gap-4 sm:hover:w-48 transition-all  overflow-hidden h-full  items-center rounded-r-lg  ">
