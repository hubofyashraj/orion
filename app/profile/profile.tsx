...
export default function Profile(props: { setPage: Function }) {
    ...
    if (info==null) return (
        ...
        <div className="relative px-6 h-[calc(100vh-64px)] w-full ">
            ...
            {imageChosen &&
                <CropComponent file={fileSelected.current!} close={()=>{setImageChosen(false) } } setFetch={()=>{setUpdated(!updated); toast('Updated!', {
                    position: "top-right",
                    autoClose: 5000,
